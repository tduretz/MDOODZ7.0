...
set_target_properties(SuiteSparse::metis PROPERTIES
  ...
  IMPORTED_LOCATION_NOCONFIG "${LIBRARY_PATH}/libmetis${LIBRARY_EXTENSION}"
  )

list(APPEND _IMPORT_CHECK_TARGETS SuiteSparse::metis )
list(APPEND _IMPORT_CHECK_FILES_FOR_SuiteSparse::metis "${LIBRARY_PATH}/libmetis${LIBRARY_EXTENSION}" )
...
set_target_properties(SuiteSparse::suitesparseconfig PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NOCONFIG "C"
  IMPORTED_LOCATION_NOCONFIG "${LIBRARY_PATH}/libsuitesparseconfig${LIBRARY_EXTENSION}"
  )

list(APPEND _IMPORT_CHECK_TARGETS SuiteSparse::suitesparseconfig )
list(APPEND _IMPORT_CHECK_FILES_FOR_SuiteSparse::suitesparseconfig "${LIBRARY_PATH}/libsuitesparseconfig${LIBRARY_EXTENSION}" )
...
set_target_properties(SuiteSparse::amd PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NOCONFIG "C"
  IMPORTED_LOCATION_NOCONFIG "${LIBRARY_PATH}/libamd${LIBRARY_EXTENSION}"
  )

list(APPEND _IMPORT_CHECK_TARGETS SuiteSparse::amd )
list(APPEND _IMPORT_CHECK_FILES_FOR_SuiteSparse::amd "${LIBRARY_PATH}/libamd${LIBRARY_EXTENSION}" )
...
set_target_properties(SuiteSparse::btf PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NOCONFIG "C"
  IMPORTED_LOCATION_NOCONFIG "${LIBRARY_PATH}/libbtf${LIBRARY_EXTENSION}"
  )

list(APPEND _IMPORT_CHECK_TARGETS SuiteSparse::btf )
list(APPEND _IMPORT_CHECK_FILES_FOR_SuiteSparse::btf "${LIBRARY_PATH}/libbtf${LIBRARY_EXTENSION}" )
...
set_target_properties(SuiteSparse::camd PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NOCONFIG "C"
  IMPORTED_LOCATION_NOCONFIG "${LIBRARY_PATH}/libcamd${LIBRARY_EXTENSION}"
  )

list(APPEND _IMPORT_CHECK_TARGETS SuiteSparse::camd )
list(APPEND _IMPORT_CHECK_FILES_FOR_SuiteSparse::camd "${LIBRARY_PATH}/libcamd${LIBRARY_EXTENSION}" )
...
set_target_properties(SuiteSparse::ccolamd PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NOCONFIG "C"
  IMPORTED_LOCATION_NOCONFIG "${LIBRARY_PATH}/libccolamd${LIBRARY_EXTENSION}"
  )

list(APPEND _IMPORT_CHECK_TARGETS SuiteSparse::ccolamd )
list(APPEND _IMPORT_CHECK_FILES_FOR_SuiteSparse::ccolamd "${LIBRARY_PATH}/libccolamd${LIBRARY_EXTENSION}" )
...
set_target_properties(SuiteSparse::colamd PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NOCONFIG "C"
  IMPORTED_LOCATION_NOCONFIG "${LIBRARY_PATH}/libcolamd${LIBRARY_EXTENSION}"
  )

list(APPEND _IMPORT_CHECK_TARGETS SuiteSparse::colamd )
list(APPEND _IMPORT_CHECK_FILES_FOR_SuiteSparse::colamd "${LIBRARY_PATH}/libcolamd${LIBRARY_EXTENSION}" )
...
set_target_properties(SuiteSparse::cholmod PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NOCONFIG "C"
  IMPORTED_LOCATION_NOCONFIG "${LIBRARY_PATH}/libcholmod${LIBRARY_EXTENSION}"
  )

list(APPEND _IMPORT_CHECK_TARGETS SuiteSparse::cholmod )
list(APPEND _IMPORT_CHECK_FILES_FOR_SuiteSparse::cholmod "${LIBRARY_PATH}/libcholmod${LIBRARY_EXTENSION}" )
...
set_target_properties(SuiteSparse::cxsparse PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NOCONFIG "C"
  IMPORTED_LOCATION_NOCONFIG "${LIBRARY_PATH}/libcxsparse${LIBRARY_EXTENSION}"
  )

list(APPEND _IMPORT_CHECK_TARGETS SuiteSparse::cxsparse )
list(APPEND _IMPORT_CHECK_FILES_FOR_SuiteSparse::cxsparse "${LIBRARY_PATH}/libcxsparse${LIBRARY_EXTENSION}" )
...
set_target_properties(SuiteSparse::klu PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NOCONFIG "C"
  IMPORTED_LOCATION_NOCONFIG "${LIBRARY_PATH}/libklu${LIBRARY_EXTENSION}"
  )

list(APPEND _IMPORT_CHECK_TARGETS SuiteSparse::klu )
list(APPEND _IMPORT_CHECK_FILES_FOR_SuiteSparse::klu "${LIBRARY_PATH}/libklu${LIBRARY_EXTENSION}" )
...
set_target_properties(SuiteSparse::ldl PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NOCONFIG "C"
  IMPORTED_LOCATION_NOCONFIG "${LIBRARY_PATH}/libldl${LIBRARY_EXTENSION}"
  )

list(APPEND _IMPORT_CHECK_TARGETS SuiteSparse::ldl )
list(APPEND _IMPORT_CHECK_FILES_FOR_SuiteSparse::ldl "${LIBRARY_PATH}/libldl${LIBRARY_EXTENSION}" )
...
set_target_properties(SuiteSparse::umfpack PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NOCONFIG "C"
  IMPORTED_LOCATION_NOCONFIG "${LIBRARY_PATH}/libumfpack${LIBRARY_EXTENSION}"
  )

list(APPEND _IMPORT_CHECK_TARGETS SuiteSparse::umfpack )
list(APPEND _IMPORT_CHECK_FILES_FOR_SuiteSparse::umfpack "${LIBRARY_PATH}/libumfpack${LIBRARY_EXTENSION}" )
...
set_target_properties(SuiteSparse::spqr PROPERTIES
  ...
  IMPORTED_LOCATION_NOCONFIG "${LIBRARY_PATH}/libspqr${LIBRARY_EXTENSION}"
  )

list(APPEND _IMPORT_CHECK_TARGETS SuiteSparse::spqr )
list(APPEND _IMPORT_CHECK_FILES_FOR_SuiteSparse::spqr "${LIBRARY_PATH}/libspqr${LIBRARY_EXTENSION}" )
