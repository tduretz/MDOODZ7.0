...
described in [Duretz et al. 2025 G3](../../../bib/anisotropy_calibration_2026/Duretz_etal_2025_lithospheric_anisotropy_continental_rifting_G3.pdf)
...
[`~/bib/anisotropy_calibration_2026/`](../../../bib/anisotropy_calibration_2026/);
...
in [Hansen+16 part 1](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2016_olivine_textured_aggregates_anisotropy_part1_EPSL.pdf) — 38 samples spanning
single-crystal seeds, polycrystalline aggregates, and natural starting
fabrics. It folds in the original high-γ baseline of
[Bystricky+00](../../../bib/anisotropy_calibration_2026/olivine/Bystricky_etal_2000_olivine_high_shear_strain_torsion_Science.pdf),
the viscous-anisotropy framework first reported in
[Hansen+12](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2012_olivine_viscous_anisotropy_lab_torsion_Nature.pdf),
the protracted-fabric data of
[Hansen+14](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2014_olivine_protracted_fabric_evolution_EPSL.pdf),
the wet Fo50 corner of
[Tasaka+16](../../../bib/anisotropy_calibration_2026/olivine/Tasaka_etal_2016_wet_Fo50_torsion_dislocation_creep_JGR.pdf),
and the natural-sample CPO evolution of
[Kumamoto+19](../../../bib/anisotropy_calibration_2026/olivine/Kumamoto_etal_2019b_Josephine_part2_olivine_CPO_evolution_JGR.pdf).
...
[Hansen+16 part 2](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2016_olivine_textured_aggregates_anisotropy_part2_micromechanical_JGR.pdf)
(§3 model description, §5 / Fig 9 model-vs-data comparison);
[Skemer & Hansen 16](../../../bib/anisotropy_calibration_2026/olivine/Skemer_Hansen_2016_upper_mantle_anisotropy_review_Tectonophysics.pdf)
collates the lot.

### 1.2 The two-step empirical relationship

> **Note on provenance of the three constants.**
> - `24.5` **is** printed verbatim — [Hansen+12 Fig 3b](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2012_olivine_viscous_anisotropy_lab_torsion_Nature.pdf) carries the in-figure annotation `δ = (24.5 ± 5.5)M + 1` (PDF text-layer, Ctrl-F `"24.5 ± 5.5"`).
...
([Hansen+14](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2014_olivine_protracted_fabric_evolution_EPSL.pdf) Fig 6a,c — *M*-index vs shear strain in dry single-/poly-crystal aggregates;
[Hansen+16 part 1](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2016_olivine_textured_aggregates_anisotropy_part1_EPSL.pdf) Fig 6b and Fig 7b — *M*-index vs shear strain with the saturation plateau;
[Skemer & Hansen 16](../../../bib/anisotropy_calibration_2026/olivine/Skemer_Hansen_2016_upper_mantle_anisotropy_review_Tectonophysics.pdf) §4.3 / Fig 6):
...
Single-paper fits scatter ±5 % around the combined-fit asymptote. The committed pair `(0.536, 3.96)` is the combined-fit result. Independent torsion-series data from [Bystricky+00](../../../bib/anisotropy_calibration_2026/olivine/Bystricky_etal_2000_olivine_high_shear_strain_torsion_Science.pdf) (Fig 2 — *J*-index, not *M*-index; reported as Bystricky's strength measure) lie on the same trend after the $J\to M$ remapping documented in [`hansen2012_comparison.md` §7.2](../../misc/aniso_fstrain/notes/hansen2012_comparison.md), but are not used in the committed fit to keep the index definition uniform.

**Step B — viscous-anisotropy magnitude δ is linear in M.** The δ–M linear regression comes directly from [Hansen+12 Fig 3b](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2012_olivine_viscous_anisotropy_lab_torsion_Nature.pdf), where the in-figure annotation reads $\delta = (24.5 \pm 5.5)\,M + 1$ (PDF text-layer searchable as literal `"24.5 ± 5.5"`):
...
**Independent cross-check on δ_∞** (also in [`hansen2012_comparison.md` §7.3](../../misc/aniso_fstrain/notes/hansen2012_comparison.md)). [Hansen+16 part 1](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2016_olivine_textured_aggregates_anisotropy_part1_EPSL.pdf) Eqs 3–4 (stress-aware Hill-parameter formulation) give $\delta_\infty = (F_s/F_w)^n = (1.39/0.73)^{4.1} = 14.02$. Two independent calibrations converge on $\delta_\infty \approx 14$ — this is the strongest single-asymptote validation available for olivine.
...
4. δ is consumed by `ViscosityConciseAniso` in the transversely-
   ...
   [Duretz+25](../../../bib/anisotropy_calibration_2026/Duretz_etal_2025_lithospheric_anisotropy_continental_rifting_G3.pdf)
...
- **Memory.** Cratonic mantle xenoliths preserve CPO for ≳1 Ga
  ([Tommasi & Vauchez 15](../../../bib/anisotropy_calibration_2026/olivine/Tommasi_Vauchez_2015_lithospheric_mantle_heterogeneity_anisotropy_Tectonophysics.pdf)).
...
- **DiSRX above ~1100 °C** modifies grain boundaries and partially
  resets CPO ([Boneh+21](../../../bib/anisotropy_calibration_2026/olivine/Boneh_etal_2021_olivine_postdeformation_annealing_microstructural_shift_G3.pdf);
  [Boneh+17](../../../bib/anisotropy_calibration_2026/olivine/Boneh_etal_2017_oriented_grain_growth_frozen_anisotropy_EPSL.pdf)).
...
[Boneh+21](../../../bib/anisotropy_calibration_2026/olivine/Boneh_etal_2021_olivine_postdeformation_annealing_microstructural_shift_G3.pdf)
...
experiments in [Hansen+16 part 1](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2016_olivine_textured_aggregates_anisotropy_part1_EPSL.pdf)
...
geometry](../../../bib/anisotropy_calibration_2026/olivine/Karato_2008_deformation_of_earth_materials_rheology_textbook_CambridgeUP.pdf))
to the foliation frame in which F-major lies along the fabric
([Hansen+14](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2014_olivine_protracted_fabric_evolution_EPSL.pdf) Fig 6;
[Hansen+16 part 1](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2016_olivine_textured_aggregates_anisotropy_part1_EPSL.pdf) Fig 5 — pole figures aligned with the shear plane).
This is the same convention as [Duretz+25 Eq 9](../../../bib/anisotropy_calibration_2026/Duretz_etal_2025_lithospheric_anisotropy_continental_rifting_G3.pdf) (the $Q$-rotation in which the deviatoric strain-rate tensor is rotated into material coordinates: $\dot\varepsilon' = Q\,\dot\varepsilon\,Q^{T}$ at angle $\theta$); the F-init step puts that angle and its δ-equivalent finite strain on every marker before the first solver iteration.
...
[Warren+08 Fig 9](../../../bib/anisotropy_calibration_2026/olivine/Warren_etal_2008_olivine_LPO_simple_shear_mantle_EPSL.pdf)
...
[Boneh+15 Figs 4–6](../../../bib/anisotropy_calibration_2026/olivine/Boneh_etal_2015_olivine_CPO_complex_deformation_DRex_G3.pdf)
...
is [Duretz+25 Eq 18](../../../bib/anisotropy_calibration_2026/Duretz_etal_2025_lithospheric_anisotropy_continental_rifting_G3.pdf)
...
implications](../../../bib/anisotropy_calibration_2026/olivine/Tommasi_Vauchez_2015_lithospheric_mantle_heterogeneity_anisotropy_Tectonophysics.pdf);
[Hansen+16 PNAS](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2016_olivine_anisotropy_Gutenberg_discontinuity_PNAS.pdf)
...
offset comes from
[Boneh & Skemer 14 Fig 4](../../../bib/anisotropy_calibration_2026/olivine/Boneh_Skemer_2014_pre_existing_CPO_Aheim_dunite_EPSL.pdf)
...
[Boneh+17 Fig 4](../../../bib/anisotropy_calibration_2026/olivine/Boneh_etal_2017_oriented_grain_growth_frozen_anisotropy_EPSL.pdf)
...
[Skemer & Hansen 16 §4.3 / Fig 6](../../../bib/anisotropy_calibration_2026/olivine/Skemer_Hansen_2016_upper_mantle_anisotropy_review_Tectonophysics.pdf)
...
- Calibration corpus: [`~/bib/anisotropy_calibration_2026/olivine/`](../../../bib/anisotropy_calibration_2026/olivine/).

## References

All cite paths are relative to this document
...
1. Bystricky M., Kunze K., Burlini L., Burg J.-P. (2000). High shear
   ...
   *Science* 290, 1564–1567.
   [PDF](../../../bib/anisotropy_calibration_2026/olivine/Bystricky_etal_2000_olivine_high_shear_strain_torsion_Science.pdf)
2. Hansen L.N., Zimmerman M.E., Kohlstedt D.L. (2012). The influence of
   ...
   *Nature* 492, 415–418.
   [PDF](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2012_olivine_viscous_anisotropy_lab_torsion_Nature.pdf)
3. Hansen L.N., Warren J.M., Zimmerman M.E., Kohlstedt D.L. (2014).
   ...
   [PDF](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2014_olivine_protracted_fabric_evolution_EPSL.pdf)
4. Hansen L.N., Conrad C.P., Boneh Y., Skemer P., Warren J.M.,
   ...
   [PDF](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2016_olivine_textured_aggregates_anisotropy_part1_EPSL.pdf)
5. Hansen L.N., Conrad C.P., Boneh Y., Skemer P., Warren J.M.,
   ...
   [PDF](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2016_olivine_textured_aggregates_anisotropy_part2_micromechanical_JGR.pdf)
6. Hansen L.N., Qi C., Warren J.M. (2016c). Olivine anisotropy
   ...
   [PDF](../../../bib/anisotropy_calibration_2026/olivine/Hansen_etal_2016_olivine_anisotropy_Gutenberg_discontinuity_PNAS.pdf)
7. Tasaka M., Zimmerman M.E., Kohlstedt D.L. (2016). Evolution of
   ...
   *JGR Solid Earth* 121, 92–113.
   [PDF](../../../bib/anisotropy_calibration_2026/olivine/Tasaka_etal_2016_wet_Fo50_torsion_dislocation_creep_JGR.pdf)
8. Kumamoto K.M., Warren J.M., Hansen L.N. (2019). Evolution of the
   ...
   [PDF](../../../bib/anisotropy_calibration_2026/olivine/Kumamoto_etal_2019b_Josephine_part2_olivine_CPO_evolution_JGR.pdf)
9. Boneh Y., Skemer P. (2014). The effect of pre-existing CPO on the
   ...
   [PDF](../../../bib/anisotropy_calibration_2026/olivine/Boneh_Skemer_2014_pre_existing_CPO_Aheim_dunite_EPSL.pdf)
10. Boneh Y., Morales L.F.G., Kaminski E., Skemer P. (2015). Modeling
    olivine CPO evolution with complex deformation histories. *G3*
    16, 3436–3455.
    [PDF](../../../bib/anisotropy_calibration_2026/olivine/Boneh_etal_2015_olivine_CPO_complex_deformation_DRex_G3.pdf)
11. Boneh Y., Wallis D., Hansen L.N., Krawczynski M.J., Skemer P.
    ...
    [PDF](../../../bib/anisotropy_calibration_2026/olivine/Boneh_etal_2017_oriented_grain_growth_frozen_anisotropy_EPSL.pdf)
12. Boneh Y., Wallis D., Hansen L.N. (2021). The effect of
    ...
    [PDF](../../../bib/anisotropy_calibration_2026/olivine/Boneh_etal_2021_olivine_postdeformation_annealing_microstructural_shift_G3.pdf)
13. Warren J.M., Hirth G., Kelemen P.B. (2008). Evolution of olivine
    ...
    *EPSL* 272, 501–512.
    [PDF](../../../bib/anisotropy_calibration_2026/olivine/Warren_etal_2008_olivine_LPO_simple_shear_mantle_EPSL.pdf)
14. Tommasi A., Vauchez A. (2015). Heterogeneity and anisotropy in
    the lithospheric mantle. *Tectonophysics* 661, 11–37.
    [PDF](../../../bib/anisotropy_calibration_2026/olivine/Tommasi_Vauchez_2015_lithospheric_mantle_heterogeneity_anisotropy_Tectonophysics.pdf)
15. Skemer P., Hansen L.N. (2016). Inferring upper-mantle flow from
    ...
    *Tectonophysics* 668–669, 1–14.
    [PDF](../../../bib/anisotropy_calibration_2026/olivine/Skemer_Hansen_2016_upper_mantle_anisotropy_review_Tectonophysics.pdf)
16. Karato S. (2008). *Deformation of Earth Materials: An Introduction
    to the Rheology of Solid Earth*. Cambridge University Press.
    [PDF](../../../bib/anisotropy_calibration_2026/olivine/Karato_2008_deformation_of_earth_materials_rheology_textbook_CambridgeUP.pdf)
17. Duretz T., Schmalholz S.M., Kulakov R., Mohn G., Tugend J.,
    ...
    [PDF](../../../bib/anisotropy_calibration_2026/Duretz_etal_2025_lithospheric_anisotropy_continental_rifting_G3.pdf)
