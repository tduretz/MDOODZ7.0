...
typedef double (*SetHorizontalStrainRate_f)(MdoodzInstance *instance, Coordinates coordinates);
typedef double (*SetVerticalStrainRate_f)(MdoodzInstance *instance, Coordinates coordinates);
