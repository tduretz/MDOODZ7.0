  ...
  if (tensile == 1)
  {
    ...
    if (F_trial > 1e-17)
    {
      ...
      for (int it = 0; it < nitmax; it++)
      {
        ...
        R1 = (Tii - Tiic) - eta_ve * lam_dot * dQdTii;
        ...
        // Assemble Jacobian
        J11 = -1.0 - eta_ve * lam_dot * d2QdTii2;
        J12 =       -eta_ve * lam_dot * d2QdTP;
        J13 =       -eta_ve * dQdTii;
  ...
  *Txz       = 2.0*(*etaVE)*Exz;
  ...
  if ( post_process == 1) {
    ...
    *div_r   = divr;
    ...
    if (plastic) *OverS = eta_vp*gdot;
    if (tensile) *OverS = eta_vp * lam_dot * dQdTii;
