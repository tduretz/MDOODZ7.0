...
# Write csv file for analysis with python
        name_csv_tau     = @sprintf("/home/lilou/librairies/MDOODZ7.0/JuliaVisualisation/CSV/tauII.Output%05d.csv", istep)
        name_csv_eps_dot = @sprintf("/home/lilou/librairies/MDOODZ7.0/JuliaVisualisation/CSV/eps_dotII.Output%05d.csv", istep)
