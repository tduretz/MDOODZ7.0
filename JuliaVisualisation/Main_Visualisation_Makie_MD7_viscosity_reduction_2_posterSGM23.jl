...
function plotData(NameVect, TimeVect, SxzVect, path)
    ...
    ax1 = MoC.Axis(f[1, 1], xlabel = L"γ", ylabel = L"\frac{η_{\text{eff}}}{η_{\text{0}}}")
    ...
    MoC.limits!(0,6,0,1.3) # 6 short, 16 normal, 50 long
...
function main()
    ...
    collectData!("/users/whalter1/work/aniso_fix/A5_1000/", "A",  6780, NameVect, TimeVect, SxzVect)
    collectData!("/users/whalter1/work/aniso_fix/A6_1000/", "B",  6750, NameVect, TimeVect, SxzVect)
    collectData!("/users/whalter1/work/aniso_fix/A4_1000/", "C",  25000, NameVect, TimeVect, SxzVect)
    collectData!("/users/whalter1/work/aniso_fix/A3_1000/", "D",  6750, NameVect, TimeVect, SxzVect)
    collectData!("/users/whalter1/work/aniso_fix/B2_1000/", "E",  6730, NameVect, TimeVect, SxzVect)
