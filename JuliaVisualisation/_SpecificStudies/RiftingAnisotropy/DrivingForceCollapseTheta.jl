...
function main()
    ...
    @show t_t0  =  t0["time"][ findfirst( t0["F_driving"][:]  .< 0.4*maxF[1] .&& ( t0["time"].> 1.2*t0["time"][ind0]) ) ]
    @show t_t5  =  t5["time"][ findfirst( t5["F_driving"][:]  .< 0.4*maxF[2] .&& ( t5["time"].> 1.2*t5["time"][ind5]) ) ]
    @show t_t10 =  d4["time"][ findfirst( d4["F_driving"][:]  .< 0.4*maxF[3] .&& ( d4["time"].> 1.2*d4["time"][ind10]) ) ]
    @show t_t20 = t20["time"][ findfirst( t20["F_driving"][:] .< 0.4*maxF[4] .&& (t20["time"].> 1.2*t20["time"][ind20]) ) ]
    @show t_t30 = t30["time"][ findfirst( t30["F_driving"][:] .< 0.4*maxF[5] .&& (t30["time"].> 1.2*t30["time"][ind30]) ) ]
    @show t_t45 = t45["time"][ findfirst( t45["F_driving"][:] .< 0.4*maxF[6] .&& (t45["time"].> 1.2*t45["time"][ind45]) ) ]
    @show t_t60 = t60["time"][ findfirst( t60["F_driving"][:] .< 0.4*maxF[7] .&& (t60["time"].> 1.2*t60["time"][ind60]) ) ]
    @show t_t70 = t70["time"][ findfirst( t70["F_driving"][:] .< 0.4*maxF[8] .&& (t70["time"].> 1.2*t70["time"][ind70]) ) ]
    @show t_t80 = t80["time"][ findfirst( t80["F_driving"][:] .< 0.4*maxF[9] .&& (t80["time"].> 1.2*t80["time"][ind80]) ) ]
    @show t_t90 = t90["time"][ findfirst( t90["F_driving"][:] .< 0.4*maxF[10] .&&(t90["time"].> 1.2*t90["time"][ind90]) ) ]
    ...
    lines!(ax2, time_t60.-time_t60[1], t60["F_driving"][ind60:end]./1e12 ./ fit_force_data[7] , label=L"$\theta_\textrm{ini} = 60$")  
    lines!(ax2, time_t70.-time_t70[1], t70["F_driving"][ind70:end]./1e12 ./ fit_force_data[8] , label=L"$\theta_\textrm{ini} = 70$")  
    lines!(ax2, time_t80.-time_t80[1], t80["F_driving"][ind80:end]./1e12 ./ fit_force_data[9] , label=L"$\theta_\textrm{ini} = 80$")  
    lines!(ax2, time_t90.-time_t90[1], t90["F_driving"][ind90:end]./1e12 ./ fit_force_data[10], label=L"$\theta_\textrm{ini} = 90$")  
