...
@views function main()
    ...
    if field==:StrainRate
        ...
        # DefMech[isnan.(DefMech)] .= 0
        # DefMech .= Int64.(DefMech)
        ...
        hm = heatmap!(ax2, xc./Lc, zc./Lc, DefMech, colormap = cgrad(:vik, 4; categorical = true, alpha = 0.8), colorrange=(0.5, 4.5))
        ...
        cbar =Colorbar(f, hm, label = L"$$Mechanisms", width = 320, height = 25,
        ...
        tickcolor = :black)
        cbar.ticks = ([1,2,3,4], ["el","pl","pwl","lin"])
        xb = -[0.; -100.]
        yb = [-100.; -70.]
        ...
        hm = heatmap!(ax3, xc./Lc, zc./Lc, DefMech, colormap = Makie.Categorical((cmap,  options.α_heatmap)), colorrange=(1, 4))
