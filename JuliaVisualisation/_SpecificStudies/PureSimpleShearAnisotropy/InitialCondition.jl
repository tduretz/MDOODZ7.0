...
@views function main()
    ...
    for istep=file_start:file_step:file_end
        ...
        if field==:Phases
            ...
            ax1 = Axis(f[1, 1], title = L"$$A) Initial model configuration", xlabel = L"$x$ [km]", ylabel = L"$y$ [km]")
            ...
            Mak.contour!(ax1, coords.c.x./scales.Lc, coords.c.z./scales.Lc, T, levels=0:300:1250, linewidth = 4, color=:gray )  
            ...
            Mak.arrows!(ax1, coords.c.x[1:V.step:end]./scales.Lc, coords.c.z[1:V.step:end]./scales.Lc, Fab.x[1:V.step:end,1:V.step:end], Fab.z[1:V.step:end,1:V.step:end], arrowsize = 0, lengthscale=10Δ/1.5, linewidth=3)
            ...
            save("/Users/tduretz/PowerFolders/_manuscripts/PureSimpleShearAnisotropy/Figures/InitialConfiguration.png", f, px_per_unit = 4) 
