...
function WriteMATFile(name, x, z, Fab)

    # @show typeof(x), typeof(z), typeof(Fab.x)
...
@views function main()
    ...
    if field==:StrainRate
        ...
        WriteMATFile("Aniso_d4t5", xc, zc, Fab)                

        #############################################################
    
        # save("/Users/tduretz/PowerFolders/_manuscripts/PureSimpleShearAnisotropy/Figures/SymmetricAsymmetric_AngleStrain_proof.png", f, px_per_unit = 4)     
        display(f)
