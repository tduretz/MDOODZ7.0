...
CI verification that the thermo-elastic coupling produces correct pressure response to imposed temperature changes, using both CHOLMOD and PCG backends.
