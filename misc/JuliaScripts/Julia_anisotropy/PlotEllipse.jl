...
enhanced_font_size = 18  # Increased font size
...
# Adjusted text positions to avoid overlap
annotate!(0.9*τ_ΙΙ, 0.1, Plots.text("\$\\tau_{χχ}'\$", :center, enhanced_font_size))
annotate!(-0.2, 0.9*τ_ΙΙ, Plots.text("\$\\tau_{χy}'\$", :center, enhanced_font_size))
