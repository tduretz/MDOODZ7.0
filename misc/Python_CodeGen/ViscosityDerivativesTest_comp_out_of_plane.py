...
# !!!!!!!!!! SUBSTITUTE DU PROCUREUR DE OUT OF PLANE
Tzz = -(Txx+Tyy)
Ezz = -(Exx+Eyy)
# !!!!!!!!!! SUBSTITUTE DU PROCUREUR DE OUT OF PLANE
...
lamdot    = Function('lamdot')(Exx,Eyy,Exy,P)
Tau_yield = C*cos(phi) + P*sin(phi) + eta_Kel*lamdot
...
eta_trial = Function('eta_trial')(Exx,Eyy,Exy)
F_trial   = Function('F_trial')(Exx,Eyy,Exy,P)
...
Tii     = 2*eta_trial*Eii
F_trial = Tii - P*sin(phi) - C*cos(phi)
